...
| 카테고리 | 파일 | 요약 |
|----------|------|------|
| 도구 제약 | tool-constraints.md | Kiro subagent 제약(delegate 전역 상태 crosstalk 실체 + use_subagent in-band 실측 포함), git commit 따옴표 소실, Format-Table 출력 소실, README 동기화 주의점 |
...
## Last Updated
2026-08-19 (Mickey 42 — tool-constraints에 delegate crosstalk 실체 + Format-Table 출력 소실 추가)
